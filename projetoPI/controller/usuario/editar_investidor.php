...
if(isset($_POST['nome']) && empty($_POST['nome']) == false){
    ...
    $sql = "UPDATE tb_usuario_investidor SET nome = '$nome', email= '$email',celular='$celular',telefone='$telefone',investimentoPretendido='$investimentoPretendido',cpf='$cpf',cep='$cep',logradouro='$logradouro',numero_casa='$numero_casa',bairro='$bairro',complemento='$complemento',cidade='$cidade',estado='$estado' WHERE id = '$id'";
    $pdo->query($sql);
    header("Location: administrador_investidor.php");
}

    $sql = "SELECT * FROM tb_usuario_investidor WHERE id = '$id'";
    $sql = $pdo->query($sql);
